...
namespace Math {
    ...
    struct Vec3 {
        ...
        static Vec3 closest(Vec3 a, Vec3 b, Vec3 target = Vec3(0)) {
            float a_distance = Vec3::distance_squared(a, target);
            float b_distance = Vec3::distance_squared(b, target);
        ...
        static Vec3 move_toward(Vec3 a, Vec3 b, float dt) {
            ...
            ret.x = Math::move_toward(a.x, b.x, dt);
            ret.y = Math::move_toward(a.y, b.y, dt);
            ret.z = Math::move_toward(a.z, b.z, dt);
    ...
    struct Vec4 {
        ...
        static Vec4 closest(Vec4 a, Vec4 b, Vec4 target = Vec4(0)) {
            float a_distance = Vec4::distance_squared(a, target);
            float b_distance = Vec4::distance_squared(b, target);
        ...
        static Vec4 move_toward(Vec4 a, Vec4 b, float dt) {
            ...
            ret.y = Math::move_toward(a.y, b.y, dt);
            ret.z = Math::move_toward(a.z, b.z, dt);
            ret.w = Math::move_toward(a.w, b.w, dt);
    ...
    struct IVec4 {
        ...
        static IVec4 closest(IVec4 a, IVec4 b, IVec4 target = IVec4(0)) {
            float a_distance = IVec4::distance_squared(a, target);
            float b_distance = IVec4::distance_squared(b, target);
    ...
    struct AABB {
        ...
        static bool line_intersection(AABB aabb, Vec3 p0, Vec3 p1) {
			float tmin = -10000;
			float tmax = 10000;
