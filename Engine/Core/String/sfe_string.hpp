...
namespace String {
    ...
    void Append(char* str, u64 &str_length_out, std::size_t str_capacity, const char* to_append, u64 to_append_length);
    void Append(char* str, u64 &str_length_out, std::size_t str_capacity, char to_append);
